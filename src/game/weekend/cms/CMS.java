...
import game.weekend.simplelibrary.GBL;
import game.weekend.simplelibrary.Loc;
import game.weekend.simplelibrary.Mes;
...
public class CMS {
	...
	private void makeJFrame() {
		...
		frame.setIconImage(Img.getImageIcon(Icons.Game).getImage());
		...
		gbl.addFixL(new JLabel(Loc.get("email (1)") + ":"), 1);
		gbl.newLine();
		gbl.addExtH(fldMail1, 10);
		gbl.newLine();
		gbl.addFixL(new JLabel(Loc.get("email (2)") + ":"), 1);
		gbl.newLine();
		gbl.addExtH(fldMail2, 10);
		gbl.newLine();
	...
	private void readFromSiteDescriptor() {
		...
		fldMail1.setText(siteDescriptor.getMail1());
		fldMail2.setText(siteDescriptor.getMail2());
	...
	private void writeToSiteDescriptor() {
		...
		siteDescriptor.setMail1(fldMail1.getText());
		siteDescriptor.setMail2(fldMail2.getText());
	...
	private JTextField fldMail1 = new JTextField();
	private JTextField fldMail2 = new JTextField();
