...
To better understand the explanations below, launch the program and open the website you created with it. We see that the website consists of two types of pages: the [home page](https://weekend-game.github.io/) and [project pages](https://weekend-game.github.io/cms.htm) like this one. All project pages are essentially the same.
...
Details of the program's implementation can be found on the [project page](https://weekend-game.github.io/cms.htm#ProgDescr).
...
The [blog](https://weekend-game.github.io/blog.htm) is growing rapidly. I need to archive old posts.

I need to create a filter in the [blog](https://weekend-game.github.io/blog.htm) that will allow me to filter posts by specific projects.
